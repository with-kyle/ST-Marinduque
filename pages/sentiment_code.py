...
st.set_page_config(layout="wide", page_title="Sentiment Analyzer App")

st.header("Sentiment Analyzer Code")
st.write("This app demonstrates Sentiment Analyzer.")
...
# Footer
st.write("Explore emotion analysis by entering text and analyzing its predicted emotion!")
